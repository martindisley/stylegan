...
def training_loop(
    ...
    resume_run_id           = "/root/stylegan/pretrained_models/karras2019stylegan-ffhq-1024x1024.pkl",     # Run ID or network pkl to resume training from, None = start from scratch.
