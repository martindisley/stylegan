...
def training_loop(
    ...
    #resume_run_id           = "latest_model.pkl", # Run ID or network pkl to resume training from, None = start from scratch.
    resume_run_id           = misc.pick_up_from_latest_snapshot()[0],
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = misc.pick_up_from_latest_snapshot()[1],      # Assumed training progress at the beginning. Affects reporting and training schedule.
